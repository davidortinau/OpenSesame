...
namespace OpenSesame.iOS.Services
{
	public class AudioRecorderService : IAudioRecorderService
	{
		...
		void InitializeRecorder()
		{
			...
			string audioFilePath = $"{PCLStorage.FileSystem.Current.LocalStorage.Path}/{Constants.AudioFilename}";
